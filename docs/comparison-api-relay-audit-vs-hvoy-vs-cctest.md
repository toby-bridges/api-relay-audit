...
1. **公开排行榜**：40+ 真实中转站的在线率、掺水率、延迟、最新状态。这是 api-relay-audit 和 cctest.ai 都没有的——你不用自己跑审计，直接看结果。这对不愿意/不会用 CLI 的普通用户价值很大。

2. **中转站推荐页**：带价格、评价、和"推荐/中性/不推荐"评级。虽然是作者个人测试结果，但对新用户选站有直接参考价值。
