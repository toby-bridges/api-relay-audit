...
from api_relay_audit.refusal import (
    CLAUDE_SELF_ID_MARKERS,
    REFUSAL_MARKERS,
    STRUCTURAL_LEAK_PATTERNS,
    contains_claude_self_id,
    is_benign_claude_refusal,
    looks_like_refusal,
    matches_structural_leak,
)
...
# Re-export underscore-prefixed names so test_refusal_detector.py (which
# loads this module via importlib and accesses modular._looks_like_refusal
# etc.) continues to work without changes.
_looks_like_refusal = looks_like_refusal
_contains_claude_self_id = contains_claude_self_id
_matches_structural_leak = matches_structural_leak
_is_benign_claude_refusal = is_benign_claude_refusal
